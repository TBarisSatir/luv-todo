...
import io.github.tbarissatir.luv_todo.service.RuleViolationException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleRuleViolation(RuleViolationException ex) {
